// Normalize the sidebar nav across all 28 pages to the canonical 9 items.
// Order: index, discoveries, insights, portfolio, ops, notifications, archive, collections, settings
...
console.log(JSON.stringify({ total: files.length, failed: report.filter((r) => !r.ok) }, null, 2));
