...
import {
  Radar, SatelliteDish, Droplets, CalendarDays, LineChart, ClipboardCheck, ServerCog,
...
const navItems = [
  ...
  { href: '/faucets', label: '水龙头', icon: Droplets },
  { href: '/calendar', label: '空投日历', icon: CalendarDays },
