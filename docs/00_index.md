...
| 04 | Frontend | [`FRONTEND_SPEC.md`](FRONTEND_SPEC.md)、`DESIGN_TOKENS.md` | ✅ |
| 05 | Database | [`DATABASE_DDL.md`](DATABASE_DDL.md) | ✅ |
| 06 | API | [`API_SPEC.md`](API_SPEC.md) | ✅ |
| 07 | Agent | `agents/README.md` + `agents/*/AGENT.md` | ✅ |
| 08 | AI / LLM | [`adr/ADR-001-llm-default-off.md`](adr/ADR-001-llm-default-off.md)、`prompts/README.md` | ✅ |
...
| 14 | Decisions (ADR) | `docs/adr/`（ADR-001~011 + `TEMPLATE.md`） | ✅ |
